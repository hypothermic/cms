...
<html class="no-js" lang="">
    <head>
        ...
        <!-- De beschrijving en eigenschappen van onze pagina -->
        <title><? echo VENDOR_NAME ?></title>
        <meta name="description" content="<? echo VENDOR_DESCRIPTION ?>">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <meta name="theme-color" content="<? echo VENDOR_THEME_COLOR_PRIMARY?>">
    ...
    <body>
        <!-- Onze website werkt niet met Internet Explorer 7 en lager-->
        <!--[if IE]>
